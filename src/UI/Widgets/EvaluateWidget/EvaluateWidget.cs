...
namespace UnityExplorer.UI.Widgets
{
    public class EvaluateWidget : IPooledObject
    {
        ...
        public GameObject CreateContent(GameObject parent)
        {
            ...
            Text genericsTitle = UIFactory.CreateLabel(genericArgumentsHolder, "GenericsTitle", LocalizationManager.GetText("generic_arguments", "Generic Arguments"), TextAnchor.MiddleLeft);
            ...
            Text argsTitle = UIFactory.CreateLabel(parametersHolder, "ArgsTitle", LocalizationManager.GetText("arguments", "Arguments"), TextAnchor.MiddleLeft);
