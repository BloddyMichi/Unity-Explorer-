...
public sealed class Notification
{
    ...
    private void ShowMessageImp(string message)
    {
        ...
        Vector3 mousePosition = ExplorerCore.IsUnity6000OrNewer
            ? InputManager.MousePosition
            : DisplayManager.MousePosition;

        popupLabel.transform.localPosition = UIManager.UIRootRect.InverseTransformPoint(mousePosition) + (Vector3.up * 25);
    }
