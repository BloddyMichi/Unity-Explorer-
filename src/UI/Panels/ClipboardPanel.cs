...
namespace UnityExplorer.UI.Panels
{
    public class ClipboardPanel : UEPanel
    {
        ...
        protected override void ConstructPanelContent()
        {
            ...
            Text currentPasteTitle = UIFactory.CreateLabel(firstRow, "CurrentPasteTitle", LocalizationManager.GetText("current_paste", "Current paste:"), TextAnchor.MiddleLeft, color: Color.grey);
            ConfigManager.Menu_Language.OnValueChanged += _ => currentPasteTitle.text = LocalizationManager.GetText("current_paste", "Current paste:");
