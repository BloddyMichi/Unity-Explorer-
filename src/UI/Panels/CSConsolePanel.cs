...
namespace UnityExplorer.UI.Panels
{
    public class CSConsolePanel : UEPanel
    {
        ...
        protected override void ConstructPanelContent()
        {
            ...
            Dropdown = dropdown;
            UIFactory.SetDropdownValueChangedListener(helpDrop, Dropdown, (int val) => { this.OnDropdownChanged?.Invoke(val); });
            ...
            UIFactory.SetToggleValueChangedListener(ctrlRToggleObj, CtrlRToggle, (bool val) => { OnCtrlRToggled?.Invoke(val); });
            ...
            UIFactory.SetToggleValueChangedListener(suggestToggleObj, SuggestionsToggle, (bool val) => { OnSuggestionsToggled?.Invoke(val); });
            ...
            UIFactory.SetToggleValueChangedListener(autoIndentToggleObj, AutoIndentToggle, (bool val) => { OnAutoIndentToggled?.Invoke(val); });
        ...
        private void ConstructScrollInputField(GameObject inputArea, RectTransform linesRect, int fontSize)
        {
            ...
            UIFactory.SetScrollbarValueChangedListener(inputScroller.Slider.Scrollbar.gameObject, inputScroller.Slider.Scrollbar, (float val) => { SetLinesPosition(); });
            UIFactory.SetSliderValueChangedListener(inputScroller.Slider.Slider.gameObject, inputScroller.Slider.Slider, (float val) => { SetLinesPosition(); });
