...
namespace UnityExplorer.Inspectors
{
    public class GameObjectInspector : InspectorBase
    {
        ...
        private static bool loggedUnity6000TransformTreeFallback;
        ...
        private IEnumerable<GameObject> GetTransformEntries()
        {
            ...
            if (ExplorerCore.IsUnity6000OrNewer)
            {
                ...
                {
                    loggedUnity6000TransformTreeFallback = true;
                    ExplorerCore.Log("GameObjectInspector: Unity6000 safe mode disables child TransformTree traversal.");
                }

                // Unity 6000 IL2CPP/CoreCLR can crash while reading child transforms (native wrapper invalidation).
                // Return no roots to keep inspector stable.
                return Enumerable.Empty<GameObject>();
            }
        ...
        public override GameObject CreateContent(GameObject parent)
        {
            ...
            if (ExplorerCore.IsUnity6000OrNewer)
            {
                ...
                Content = UIFactory.CreateVerticalGroup(
                    UIRoot,
                    "GameObjectInspectorContent",
                    true,
                    false,
                    true,
                    true,
                ...
                UIFactory.SetLayoutElement(Content, minHeight: 250, preferredHeight: 300, flexibleHeight: 0, flexibleWidth: 9999);
            }
            else
            {
                GameObject scrollObj = UIFactory.CreateScrollView(
                    UIRoot,
                    "GameObjectInspector",
                    out Content,
                    out AutoSliderScrollbar scrollbar,
                    new Color(0.065f, 0.065f, 0.065f));
