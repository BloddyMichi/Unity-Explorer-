...
namespace UniverseLib.UI
{
    ...
    public static class UIFactory
    {
        ...
        {
            SetButtonClickListener(button != null ? button.gameObject : null, button, () => button.OnDeselect(null));
        }

        public static void SetButtonClickListener(GameObject owner, Button button, Action onClick)
        {
            if (owner == null || button == null || onClick == null)
                return;

            ButtonClickRelay.Register(button, onClick);
        }

        public static void SetDropdownValueChangedListener(GameObject owner, Dropdown dropdown, Action<int> onValueChanged)
        {
            if (owner == null || dropdown == null || onValueChanged == null)
                return;

            DropdownValueChangedRelay.Register(dropdown, onValueChanged);
        }

        public static void SetSliderValueChangedListener(GameObject owner, Slider slider, Action<float> onValueChanged)
        {
            if (owner == null || slider == null || onValueChanged == null)
                return;

            SliderValueChangedRelay.Register(slider, onValueChanged);
        }

        public static void SetScrollbarValueChangedListener(GameObject owner, Scrollbar scrollbar, Action<float> onValueChanged)
        {
            if (owner == null || scrollbar == null || onValueChanged == null)
                return;

            ScrollbarValueChangedRelay.Register(scrollbar, onValueChanged);
        }

        public static void SetScrollRectValueChangedListener(GameObject owner, ScrollRect scrollRect, Action<Vector2> onValueChanged)
        {
            if (owner == null || scrollRect == null || onValueChanged == null)
                return;

            ScrollRectValueChangedRelay.Register(scrollRect, onValueChanged);
        }

        public static void SetToggleValueChangedListener(GameObject owner, Toggle toggle, Action<bool> onValueChanged)
        {
            if (owner == null || toggle == null || onValueChanged == null)
                return;

            ToggleValueChangedRelay.Register(toggle, onValueChanged);
        }

        internal static void SetInputFieldEndEditListener(GameObject owner, InputField inputField, Action<string> onEndEdit)
        {
            if (owner == null || inputField == null || onEndEdit == null)
                return;

            InputFieldEndEditRelay.Register(inputField, onEndEdit);
        }

        internal static void SetInputFieldValueChangedListener(GameObject owner, InputField inputField, Action<string> onValueChanged)
        {
            if (owner == null || inputField == null || onValueChanged == null)
                return;

            InputFieldValueChangedRelay.Register(inputField, onValueChanged);
        }
            ...
            int checkWidth = 20, int checkHeight = 20)
        {
            ...
            SetToggleValueChangedListener(toggleObj, toggleRef, _ => toggleRef.OnDeselect(null));
            ...
            Action<int> onValueChanged, string[] defaultOptions = null)
        {
            ...
            SetToggleValueChangedListener(itemObj, itemToggle, _ => itemToggle.OnDeselect(null));
            ...
            if (onValueChanged != null)
                SetDropdownValueChangedListener(dropdownObj, dropdown, onValueChanged);
