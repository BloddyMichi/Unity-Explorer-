...
namespace UniverseLib.UI.Widgets
{
    ...
    public class AutoSliderScrollbar : UIBehaviourModel
    {
        ...
        public AutoSliderScrollbar(Scrollbar scrollbar, Slider slider, RectTransform contentRect, RectTransform viewportRect)
        {
            ...
            UIFactory.SetScrollbarValueChangedListener(this.Scrollbar.gameObject, this.Scrollbar, this.OnScrollbarValueChanged);
            UIFactory.SetSliderValueChangedListener(this.Slider.gameObject, this.Slider, this.OnSliderValueChanged);
