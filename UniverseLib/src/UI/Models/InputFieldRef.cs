...
namespace UniverseLib.UI.Models
{
    ...
    public class InputFieldRef : UIModel
    {
        ...
        /// <summary>
        /// Invoked when editing is committed by submit or deselect.
        /// </summary>
        ...
        public InputFieldRef(InputField component)
        {
            ...
            UIFactory.SetInputFieldValueChangedListener(component.gameObject, component, OnInputChanged);
            UIFactory.SetInputFieldEndEditListener(component.gameObject, component, OnInputEndEdit);
        }
