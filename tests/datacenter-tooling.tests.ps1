...
Assert-Contains "readme documents hover target label" $Readme "Show target name while aiming"
Assert-Contains "changelog documents hover target label" $Changelog "hover target label|Hover-Zielanzeige"
